                                        ...
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Category Title">
                                                    <p class="text-danger">
                                                        {{ $errors->first('title') }}
                                                    </p>
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                <label for="">Front Image Preview:</label>
                                                <img id="front_image_output" style="height: 150px; width:150px;" src="{{ Storage::disk('uploads')->url('noimage.jpg') }}">
                                            </div>
                                            <div class="col-md-9">
                                                <div class="form-group">
