    ...
    <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create a Courses <a href="{{ route('courses.index') }}" class="btn btn-primary">View Courses</a></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="month_intake" placeholder="Enter month intake">
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="visa_duration" placeholder="Enter Visa Duration">
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="requirements" id="summernote1" class="form-control"></textarea>
                                                    <p class="text-danger">
