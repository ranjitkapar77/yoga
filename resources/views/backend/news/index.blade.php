    ...
    <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Blogs <a href="{{ route('news.create') }}" class="btn btn-primary">Add Blogs</a></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                                @foreach ($news as $news_item)
                                                    <tr>
                                                        <td>
                                                            <img src="{{ Storage::disk('uploads')->url($news_item->cover_image) }}" alt="{{ $news_item->title }}" style="height: 90px; width: 150px;">
                                                        </td>
                                                        <td>
                                                            {{$news_item->title}} <br>
                                                        </td>
