    ...
    <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
            ...
            <div class="container-fluid">
                <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Create a Blogs <a href="{{ route('news.index') }}" class="btn btn-primary">View Blogs</a></h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="descriptive_title" placeholder="Enter Descriptive Title">
                                                    <p class="text-danger">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control" name="written_on" value="{{ date('Y-m-d') }}">
                                                    <p class="text-danger">
