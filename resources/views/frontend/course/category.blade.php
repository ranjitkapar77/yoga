...
@section('content')
    ...
    <section class="page-title-area d-flex align-items-end" style="background-image: url({{Storage::disk('uploads')->url($category->image); }});">
        <div class="container">
            <div class="row align-items-end">
                <div class="col-lg-12">
                    <div class="page-title-wrapper mb-50">
                       <h1 class="page-title mb-25">{{$category->title}}</h1>
                       <div class="breadcrumb-list">
                          <ul class="breadcrumb">
                              <li><a href="@php echo url('/'); @endphp">Home - Pages -</a></li>
                              <li><a href="{{url()->current()}}">{{$category->title}}</a></li>
                          </ul>
                       </div>
                  </div>
                </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                     <div class="section-title text-center mb-30">
                         <h5 class="bottom-line mb-25">Study In {{$category->title}}</h5>
